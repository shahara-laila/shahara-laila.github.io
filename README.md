...
Update `_config.yml` with your social profile handles:
...
Update the Google Drive CV link in `pages/cv.md`:

```yaml
cv_drive_url: "https://drive.google.com/file/d/YOUR_FILE_ID/preview"
cv_download_url: "https://drive.google.com/uc?export=download&id=YOUR_FILE_ID"
```
